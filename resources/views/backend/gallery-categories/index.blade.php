                            ...
                            <table class="table table-row-bordered table-row-dashed align-middle gs-0 gy-4" id="kt_customers_table">
                                ...
                                <thead>
                                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0 border-bottom border-gray-200">
                                        ...
                                        <th class="min-w-100px">Gallery Count</th>
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    @forelse($galleryCategories as $gct)
                                        ...
                                        <td class="ps-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <span class="text-gray-800 fw-bold mb-1">{{$gct->name}}</span>
                                                    <span class="text-gray-500 fs-7">ID: #{{$gct->id}}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="badge badge-light-info fw-bold fs-6">
                                                {{$gct->galleries->count()}} Galleries
                                            </span>
                                        </td>
                                        <td>
                                            @if($gct->status == 1 || $gct->status == true)
                                        ...
                                        <td class="text-end pe-3">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{route('admin.gallery-categories.edit',$gct->id)}}" class="menu-link px-3">
                                                ...
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a onclick="deleteItem({{$gct->id}},'{{route('admin.gallery-categories.destroy',$gct->id)}}')" class="menu-link px-3 text-danger" data-kt-customer-table-filter="delete_row">
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center py-15">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <span class="text-gray-500 fs-6 mb-5">Start by creating your first gallery category</span>
                                                <a href="{{route('admin.gallery-categories.create')}}" class="btn btn-primary btn-sm">
                                                    <i class="ki-outline ki-plus fs-2"></i>
                                                    Add Category
                                                </a>
