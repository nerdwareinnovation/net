                    ...
                    <div class="card-header border-0 pt-6 pb-5">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search stories..." />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                            ...
                            <table class="table table-row-bordered table-row-dashed align-middle gs-0 gy-4" id="kt_customers_table">
                                ...
                                <thead>
                                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0 border-bottom border-gray-200">
                                        ...
                                        <th class="min-w-200px ps-3">Story Title</th>
                                    ...
                                    <tr class="hover-elevate">
                                        ...
                                        <td class="ps-3">
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-50px me-3">
                                                    @if($story->thumbnail)
                                                        <img src="{{$story->thumbnail}}" alt="{{$story->title}}" class="w-100 rounded" />
                                                    @else
                                                ...
                                                <div class="d-flex flex-column">
                                                    <span class="text-gray-800 fw-bold mb-1">{{$story->title}}</span>
                                                    <span class="text-gray-500 fs-7">ID: #{{$story->id}}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="text-gray-800 fw-semibold">{{@$story->category->name ?? 'N/A'}}</span>
                                        </td>
                                        <td>
                                            <span class="text-gray-800 fw-semibold">{{@$story->user->name ?? 'N/A'}}</span>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-end pe-3">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" data-kt-menu="true">
                                                ...
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a onclick="deleteItem({{$story->id}},'{{route('admin.stories.destroy',$story->id)}}')" class="menu-link px-3 text-danger" data-kt-customer-table-filter="delete_row">
                                    ...
                                    <tr>
                                        <td colspan="7" class="text-center py-15">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <span class="text-gray-700 fw-bold fs-4 mb-2">No Stories Found</span>
                                                <span class="text-gray-500 fs-6 mb-5">Start by creating your first story</span>
                                                <a href="{{route('admin.stories.create')}}" class="btn btn-primary btn-sm">
                                                    <i class="ki-outline ki-plus fs-2"></i>
                                                    Add New Story
                                                </a>
