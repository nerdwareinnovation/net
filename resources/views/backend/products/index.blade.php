                    ...
                    <div class="card-header border-0 pt-6 pb-5">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search products..." />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                            ...
                            <table class="table table-row-bordered table-row-dashed align-middle gs-0 gy-4" id="kt_customers_table">
                                ...
                                <thead>
                                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0 border-bottom border-gray-200">
                                        ...
                                        <th class="min-w-200px ps-3">Product Name</th>
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    ...
                                    <tr class="hover-elevate">
                                        ...
                                        <td>
                                            <span class="text-gray-800 fw-semibold">{{$sct->category ? $sct->category->name : 'N/A'}}</span>
                                        </td>
                                        <td>
                                            @if($sct->status == 'active')
                                        ...
                                        <td class="text-end pe-3">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{route('admin.products.edit',$sct->id)}}" class="menu-link px-3">
                                                ...
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a onclick="deleteItem({{$sct->id}},'{{route('admin.products.destroy',$sct->id)}}')" class="menu-link px-3 text-danger" data-kt-customer-table-filter="delete_row">
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center py-15">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <span class="text-gray-700 fw-bold fs-4 mb-2">No Products Found</span>
                                                <span class="text-gray-500 fs-6 mb-5">Start by creating your first product</span>
                                                <a href="{{route('admin.products.create')}}" class="btn btn-primary btn-sm">
                                                    <i class="ki-outline ki-plus fs-2"></i>
                                                    Add New Product
                                                </a>
