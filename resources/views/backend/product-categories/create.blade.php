        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Product Categories</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Product Categories</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        @if(isset($category))
                            <form class="form" action="{{route('admin.product-categories.update',$category->id)}}" method="POST" enctype="multipart/form-data">@csrf
                                @method('PUT')
                        @else
                            <form class="form" action="{{route('admin.product-categories.store')}}" method="POST" enctype="multipart/form-data">@csrf
                        @endif
                            <!--begin::Modal body-->
                            <div class="py-10">
                                <!--begin::Scroll-->
                                <div class="row me-n7 pe-7">
                                    ...
                                    <div class="fv-row mb-7 col-md-12">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" value="{{@$category->name}}" class="form-control form-control-solid" placeholder="Enter Category Name" name="name" />
                                        <!--end::Input-->
                                    </div>
                                    ...
                                    <div class="fv-row mb-7 col-md-12">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <textarea type="text" id="ckeditor" class="form-control form-control-solid" name="description" >{{@$category->description}}</textarea>
                                        <!--end::Input-->
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-5 mt-7">
                                        ...
                                        <h4 class="text-gray-800 fw-bold mb-0">Category Image</h4>
                                    </div>
                                        ...
                                        <div class="card card-flush py-4">
                                            <div class="card-header">
                                                <div class="card-title">
                                                    <h5 class="fw-bold m-0">Category Icon</h5>
                                                </div>
                                            </div>
                                            <div class="card-body pt-0">
                                                <p class="text-muted mb-4">Representative image for the product category</p>
                                                <button type="button" id="chooseThumbnail" class="btn btn-primary btn-sm mb-3">
                                                    <i class="fa fa-image"></i> Choose Image
                                                </button>
                                                <input id="thumbnail" value="{{@$category->image}}" type="hidden" name="image">
