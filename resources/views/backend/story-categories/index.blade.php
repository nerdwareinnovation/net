        ...
        <div id="kt_app_toolbar" class="app-toolbar py-4 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <a href="{{route('admin.story-categories.create')}}" class="btn btn-primary btn-sm">
                    ...
                    <div class="card-header border-0 pt-6 pb-5">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search category..." />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                            ...
                            <table class="table table-row-bordered table-row-dashed align-middle gs-0 gy-4" id="kt_customers_table">
                                ...
                                <thead>
                                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0 border-bottom border-gray-200">
                                        ...
                                        <th class="min-w-100px">Story Count</th>
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    @forelse($storyCategories as $sct)
                                    <tr class="hover-elevate">
                                        ...
                                        <td class="ps-3">
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-50px me-3">
                                                    @if(isset($sct->thumbnail) && $sct->thumbnail)
                                                        <img src="{{$sct->thumbnail}}" alt="{{$sct->name}}" class="w-100 rounded" />
                                                    @else
                                        ...
                                        <td>
                                            <span class="badge badge-light-info fw-bold fs-6">
                                                {{$sct->stories->count()}} Stories
                                            </span>
                                        </td>
                                        <td>
                                            <span class="text-gray-800 fw-semibold">{{$sct->position ?? 0}}</span>
                                        </td>
                                        <td>
                                            @if($sct->status == 1 || $sct->status == true)
                                        ...
                                        <td class="text-end pe-3">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{route('admin.story-categories.edit',$sct->id)}}" class="menu-link px-3">
                                                ...
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a onclick="deleteItem({{$sct->id}},'{{route('admin.story-categories.destroy',$sct->id)}}')" class="menu-link px-3 text-danger" data-kt-customer-table-filter="delete_row">
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-center py-15">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <span class="text-gray-500 fs-6 mb-5">Start by creating your first story category</span>
                                                <a href="{{route('admin.story-categories.create')}}" class="btn btn-primary btn-sm">
                                                    <i class="ki-outline ki-plus fs-2"></i>
                                                    Add Category
                                                </a>
