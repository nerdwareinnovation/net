        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">@if(isset($category)) Edit @else Add @endif Story Category</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Story Categories</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        @if(isset($category))
                            <form class="form" action="{{route('admin.story-categories.update',$category->id)}}" method="POST" enctype="multipart/form-data">@csrf
                                @method('PUT')
                        @else
                            <form class="form" action="{{route('admin.story-categories.store')}}" method="POST" enctype="multipart/form-data">@csrf
                        @endif
                            <!--begin::Modal body-->
                            <div class="py-10">
                                <!--begin::Scroll-->
                                <div class="row me-n7 pe-7">
                                    ...
                                    <div class="fv-row mb-7 col-md-12">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <textarea class="form-control form-control-solid" name="description" rows="4" placeholder="Enter category description">{{@$category->description}}</textarea>
                                        <!--end::Input-->
                                    </div>
                                    ...
                                    <div class="fv-row mb-7 col-md-6">
                                        ...
                                        <input type="number" class="form-control form-control-solid" value="{{@$category->position ?? 0}}" placeholder="0" name="position" />
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-5 mt-7">
                                        ...
                                        <h4 class="text-gray-800 fw-bold mb-0">Category Thumbnail</h4>
                                    </div>
                                    
                                    <!--begin::Category Thumbnail-->
                                    <div class="fv-row mb-7 col-md-12">
                                        <div class="card card-flush py-4">
                                            <div class="card-header">
                                                <div class="card-title">
                                                    <h5 class="fw-bold m-0">Category Thumbnail</h5>
                                                </div>
                                            </div>
                                            <div class="card-body pt-0">
                                                <p class="text-muted mb-4">Representative image for the story category</p>
                                                <button type="button" id="chooseThumbnail" class="btn btn-primary btn-sm mb-3">
                                                    <i class="fa fa-image"></i> Choose Image
                                                </button>
                                                <input id="thumbnail" value="{{@$category->thumbnail}}" type="hidden" name="thumbnail">
                                                
                                                <div id="holder" class="thumbnail-preview">
                                                    <!-- Category image will be rendered here by JavaScript -->
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                const thumbnailItem = $(`
                    <div class="thumbnail-item">
                        <div class="thumbnail-wrapper">
                            <img src="${thumbnailUrl}" alt="Category Image">
